...
namespace AsyncInnTake2401Lab.Migrations
{
    ...
    [Migration("20221117225631_ForgotToAddDbSetForRoomAmenities")]
    partial class ForgotToAddDbSetForRoomAmenities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsyncInnTake2_401_Lab.Models.RoomAmenities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AsyncInnTake2_401_Lab.Models.RoomAmenities", b =>
                {
                    b.HasOne("AsyncInnTake2_401_Lab.Models.Amenity", "Amenities")
                        .WithOne("Room")
                        .HasForeignKey("AsyncInnTake2_401_Lab.Models.RoomAmenities", "AmenitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AsyncInnTake2_401_Lab.Models.Room", "Room")
                        .WithOne("RoomAmenities")
                        .HasForeignKey("AsyncInnTake2_401_Lab.Models.RoomAmenities", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
