...
namespace AsyncInnTake2_401_Lab.Data
{
    public class AsyncInnDbContext : DbContext
    {
     ...
     {
       modelBuilder.Entity<Room>().HasData(new Room { Id = 101, AssociatedHotel = TheNemo.Name, IsPetFriendly = true, Layout = 2, Nickname = "The Butt", Price = 475, RoomNumber = 41, RoomAmenities=One.Id });
       modelBuilder.Entity<Room>().HasData(new Room { Id = 201, AssociatedHotel = TheGreenDay.Name, IsPetFriendly = false, Layout = 0, Nickname = "The American Idiot", Price = 255, RoomNumber = 20, RoomAmenities =Two.Id });
       modelBuilder.Entity<Room>().HasData(new Room { Id = 301, AssociatedHotel = TheBroadway.Name, IsPetFriendly = true, Layout = 1, Nickname = "The Globe", Price = 670, RoomNumber = 76, RoomAmenities =Three.Id });
